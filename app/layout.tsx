...
export const metadata: Metadata = {
  ...
  description:
    "Welcome to the Mango Garden — themangotangos streams cozy RPGs, horror nights, multiplayer chaos and ASMR vibes. Join the community on Twitch and Discord.",
  keywords: [
    "themangotangos",
    "twitch streamer",
    "cozy gamer girl",
  ...
  openGraph: {
    ...
    title: "themangotangos — cozy gamer girl streaming on Twitch 🥭",
    description:
      "Join the Mango Garden — cozy RPGs, horror nights, multiplayer chaos and ASMR vibes.",
  },
  twitter: {
    card: "summary_large_image",
    title: "themangotangos — cozy gamer girl streaming on Twitch",
    description: "Cozy RPGs, horror nights, multiplayer chaos and ASMR vibes.",
    creator: "@themangotangos",
  },
  icons: {
    icon: [
